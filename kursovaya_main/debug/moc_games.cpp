...
QT_MOC_LITERAL(11, 109, 23),
QT_MOC_LITERAL(12, 133, 21),
QT_MOC_LITERAL(13, 155, 23),
QT_MOC_LITERAL(14, 179, 23),
QT_MOC_LITERAL(15, 203, 23),
QT_MOC_LITERAL(16, 227, 23),
QT_MOC_LITERAL(17, 251, 23)
    },
    "games\0LeadersFormOpen\0\0CheckGameResult\0"
    "login\0Games\0game\0score\0ShowMainForm\0"
    "PrepareGameFormToShow\0loginPlayer\0"
    "SetStyleAndShowUsername\0on_pushButton_clicked\0"
...
void games::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->ShowMainForm(); break;
        case 3: _t->PrepareGameFormToShow((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 4: _t->SetStyleAndShowUsername(); break;
        ...
        {
            typedef void (games::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&games::ShowMainForm)) {
                *result = 2;
            }
        }
    }
